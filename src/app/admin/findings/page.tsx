  ...
  return (
    <div>
      <div className={styles.pageHeader}>
        <div>
          <h1 className={styles.pageTitle}>Daftar Temuan Kendala</h1>
          <p className={styles.pageSub}>{findingsList.length} temuan tercatat di lapangan</p>
        </div>
      </div>
      ...
      <div className={`card ${styles.tableCard}`}>
        ...
        {filtered.map(finding => (
          <Link key={finding.id} href={`/admin/findings/${finding.id}`} className={styles.tableRow}>
